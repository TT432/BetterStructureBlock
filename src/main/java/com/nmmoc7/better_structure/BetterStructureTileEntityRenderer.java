...
public class BetterStructureTileEntityRenderer extends TileEntityRenderer<TileEntityBetterStructure> {
    public BetterStructureTileEntityRenderer(TileEntityRendererDispatcher p_i226006_1_) {
        super(p_i226006_1_);
    }

    @Override
    public void render(TileEntityBetterStructure tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
    ...
    @Override
    public boolean isGlobalRenderer(TileEntityBetterStructure p_188185_1_) {
        return true;
    }
}
